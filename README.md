...
| **Phase 5** (in progress) | Establishment strength/equipment on templates ✅, actual strength-at-date ✅, equipment catalog ✅, unit imagery (Commons thumbnails, lazy-load) ✅, pocket↔unit links ✅, front graphics ✅ — FEBA line with forward-edge teeth, dynamic advance arrows (computed from front movement), encirclement pincers on pockets, and curated operation arrows (Uranus/Citadel/Bagration) |
