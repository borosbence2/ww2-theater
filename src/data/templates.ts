...
// Reusable equipment profiles (key weapons list + catalog refs), so variants and
// minor-power templates field their own arms, not a German/Soviet stand-in.
const E = (name: string, count: number): EquipItem => ({ name, count });
const PROFILE: Record<string, { equipment: EquipItem[]; refs: string[] }> = {
  // German / Soviet variants reuse the German/Soviet catalog.
  dePanzer: { equipment: [E('Tanks (Pz IV/Panther)', 160), E('Tiger I (heavy coy)', 14), E('StuG / Panzerjäger', 21), E('Field howitzers', 42), E('Flak (2/8.8 cm)', 63)], refs: ['pz-iv', 'panther', 'tiger', 'stug-iii', 'marder', 'sdkfz-251', 'sdkfz-222', 'lefh-18', 'pak-40', 'flak-88', 'mg42', 'kar98k'] },
  dePzGren: { equipment: [E('Tanks / StuG', 48), E('Half-tracks (SPW)', 100), E('Field howitzers', 36), E('Flak', 12)], refs: ['pz-iv', 'stug-iii', 'sdkfz-251', 'sdkfz-222', 'lefh-18', 'pak-40', 'flak-88', 'mg42', 'kar98k'] },
  deLight: { equipment: [E('Rifles & carbines', 9000), E('MG 42', 500), E('8 cm mortars', 42), E('7.5 cm PaK', 12), E('Field howitzers', 36)], refs: ['kar98k', 'mg42', 'gw-34', 'pak-40', 'lefh-18', 'sfh-18'] },
  deFJ: { equipment: [E('Rifles & carbines', 9000), E('MG 42', 500), E('8 cm mortars', 48), E('7.5 cm PaK', 18)], refs: ['kar98k', 'mg42', 'gw-34', 'pak-40', 'lefh-18'] },
  deGebirgs: { equipment: [E('Rifles & carbines', 12000), E('MG 34', 350), E('8 cm mortars', 54), E('Mountain guns', 24)], refs: ['kar98k', 'mg34', 'gw-34', 'pak-36', 'lefh-18'] },
  suGuards: { equipment: [E('Rifles & carbines', 6330), E('SMG (PPSh)', 2010), E('Mortars', 136), E('45 mm AT', 48), E('76 mm guns', 44), E('122 mm howitzers', 12)], refs: ['mosin', 'ppsh', 'dp-28', '82-bm-37', '120-pm-38', '45mm-m37', 'zis-3', 'm-30', 'ptrd'] },
  suMountain: { equipment: [E('Rifles & carbines', 8000), E('SMG (PPSh)', 1000), E('Mortars', 90), E('76 mm mountain guns', 24)], refs: ['mosin', 'ppsh', 'dp-28', '82-bm-37', '45mm-m37', 'zis-3'] },
  suAirborne: { equipment: [E('Rifles & SMG', 7000), E('DP light MG', 350), E('Mortars', 100), E('45 mm AT', 24)], refs: ['mosin', 'ppsh', 'dp-28', '82-bm-37', '45mm-m37'] },
  // Minor powers — their own arsenals.
  itInf: { equipment: [E('Carcano rifles', 11000), E('Breda 30 LMG', 270), E('81 mm mortars', 54), E('47/32 AT', 24), E('75/18 + 100/17 howitzers', 36)], refs: ['carcano', 'breda-30', 'beretta-38', 'mortaio-81', 'cannone-47-32', 'obice-75-18', 'obice-100-17'] },
  itArm: { equipment: [E('M13/40 tanks', 184), E('L3 tankettes', 60), E('Semovente 75/18', 12), E('47/32 AT', 24)], refs: ['m13-40', 'l3-35', 'semovente-75-18', 'cannone-47-32', 'obice-75-18', 'breda-30'] },
  itMot: { equipment: [E('Carcano rifles', 9000), E('Breda 30 LMG', 200), E('47/32 AT', 24), E('75/18 howitzers', 24)], refs: ['carcano', 'breda-30', 'beretta-38', 'cannone-47-32', 'obice-75-18'] },
  itAlpine: { equipment: [E('Carcano rifles', 10000), E('Breda 30 LMG', 250), E('81 mm mortars', 54), E('75/13 pack howitzers', 24)], refs: ['carcano', 'breda-30', 'beretta-38', 'mortaio-81', 'obice-75-18'] },
  roInf: { equipment: [E('md. 1924 rifles', 12000), E('ZB-30 LMG', 300), E('Bofors 37 AT', 30), E('Škoda/Schneider howitzers', 36)], refs: ['ro-vz24', 'zb-30', 'r-2-tank', 'tacam-r2', 'bofors-37', 'skoda-100'] },
  roCav: { equipment: [E('md. 1924 rifles', 5000), E('ZB-30 LMG', 150), E('Bofors 37 AT', 12)], refs: ['ro-vz24', 'zb-30', 'bofors-37'] },
  roMtn: { equipment: [E('md. 1924 rifles', 9000), E('ZB-30 LMG', 250), E('Bofors 37 AT', 18), E('75 mm mountain guns', 24)], refs: ['ro-vz24', 'zb-30', 'bofors-37', 'skoda-100'] },
  huInf: { equipment: [E('35M rifles', 9000), E('Schwarzlose / 31M MG', 250), E('Bofors 37 AT', 24), E('Škoda howitzers', 36)], refs: ['hu-mannlicher', 'hu-schwarzlose', 'bofors-37', 'skoda-100'] },
  huCav: { equipment: [E('35M rifles', 5000), E('Toldi light tanks', 18), E('Bofors 37 AT', 12)], refs: ['hu-mannlicher', 'hu-schwarzlose', 'toldi', 'bofors-37'] },
  huArm: { equipment: [E('Turán tanks', 120), E('Toldi light tanks', 60), E('Nimród SPAA', 18), E('Zrínyi assault guns', 10)], refs: ['turan', 'toldi', 'nimrod', 'zrinyi', 'hu-mannlicher', 'bofors-37'] },
  huLight: { equipment: [E('35M rifles', 7000), E('Schwarzlose / 31M MG', 180), E('Bofors 37 AT', 12)], refs: ['hu-mannlicher', 'hu-schwarzlose', 'bofors-37'] },
  fiInf: { equipment: [E('M/39 rifles', 11000), E('Suomi SMG', 250), E('LS-26 LMG', 250), E('Lahti L-39 AT rifle', 18), E('Bofors 37 AT', 18)], refs: ['fi-m39', 'suomi', 'lahti-saloranta', 'lahti-l39', 'bofors-37'] },
  fiCav: { equipment: [E('M/39 rifles', 3000), E('Suomi SMG', 120), E('LS-26 LMG', 80)], refs: ['fi-m39', 'suomi', 'lahti-saloranta', 'bofors-37'] },
  bgInf: { equipment: [E('Mannlicher / Kar98k rifles', 12000), E('MG 34', 250), E('7.5 cm PaK', 18), E('Field howitzers', 36)], refs: ['bg-m95', 'kar98k', 'mg34', 'pak-40', 'lefh-18'] },
  yuRoyal: { equipment: [E('M1924 Mauser rifles', 16000), E('ZB-26 LMG', 400), E('Škoda/Schneider howitzers', 40)], refs: ['yu-m24', 'zb-26', 'skoda-100'] },
  yuPartisan: { equipment: [E('Captured rifles (Kar98k/Carcano)', 4000), E('Captured MGs (MG42/Breda)', 120), E('Allied SMG (Sten)', 300)], refs: ['kar98k', 'mg42', 'carcano', 'breda-30', 'sten'] },
  grInf: { equipment: [E('Mannlicher–Schönauer rifles', 14000), E('Hotchkiss MGs', 200), E('Schneider howitzers', 36)], refs: ['gr-ms', 'hotchkiss-mg'] },
  gbInf: { equipment: [E('Lee–Enfield rifles', 10000), E('Bren LMG', 600), E('Sten / Thompson SMG', 1000), E('2-pdr AT', 48), E('25-pdr field guns', 72)], refs: ['lee-enfield', 'bren', 'sten', 'qf-2pdr', 'qf-25pdr'] },
};
...
const ESTABLISHMENT: Record<string, { strength?: number; equipment?: EquipItem[]; equipmentRefs?: string[] }> = {
  ...
  // Minor powers + variants — strength and their own equipment (see PROFILE).
  'Romanian Infantry Division': { strength: 17500, equipment: PROFILE.roInf.equipment },
  'Romanian Cavalry Division': { strength: 6500, equipment: PROFILE.roCav.equipment },
  'Hungarian Infantry Division (honvéd)': { strength: 13000, equipment: PROFILE.huInf.equipment },
  'Hungarian Cavalry Division (huszár)': { strength: 6000, equipment: PROFILE.huCav.equipment },
  'Hungarian Armoured Division (páncéloshadosztály)': { strength: 12000, equipment: PROFILE.huArm.equipment },
  'Italian Infantry Division (binary)': { strength: 13000, equipment: PROFILE.itInf.equipment },
  'Italian Armoured Division': { strength: 8600, equipment: PROFILE.itArm.equipment },
  'Italian Motorized Division': { strength: 10500, equipment: PROFILE.itMot.equipment },
  'Finnish Infantry Division': { strength: 14200, equipment: PROFILE.fiInf.equipment },
  'Finnish Cavalry Brigade': { strength: 3500, equipment: PROFILE.fiCav.equipment },
  'Bulgarian Infantry Division': { strength: 15000, equipment: PROFILE.bgInf.equipment },
  'Royal Yugoslav Infantry Division': { strength: 26000, equipment: PROFILE.yuRoyal.equipment },
  'Partisan Division (NOVJ)': { strength: 4000, equipment: PROFILE.yuPartisan.equipment },
  'Greek Infantry Division': { strength: 18000, equipment: PROFILE.grInf.equipment },
  'British/Commonwealth Infantry Division': { strength: 18347, equipment: PROFILE.gbInf.equipment },
  'Gebirgs-Division (mountain)': { strength: 13000, equipment: PROFILE.deGebirgs.equipment },
  'Italian Alpine Division': { strength: 14000, equipment: PROFILE.itAlpine.equipment },
  'Romanian Mountain Division (vânători de munte)': { strength: 12000, equipment: PROFILE.roMtn.equipment },
  'Soviet Mountain Rifle Division': { strength: 9000, equipment: PROFILE.suMountain.equipment },
  'Guards Rifle Division': { strength: 10500, equipment: PROFILE.suGuards.equipment },
  'SS-Panzer-Division': { strength: 19000, equipment: PROFILE.dePanzer.equipment },
  'SS-Panzergrenadier-Division': { strength: 15000, equipment: PROFILE.dePzGren.equipment },
  'Jäger-Division (light)': { strength: 12700, equipment: PROFILE.deLight.equipment },
  'Hungarian Light Division (könnyű hadosztály)': { strength: 10000, equipment: PROFILE.huLight.equipment },
  'Fallschirmjäger-Division': { strength: 16000, equipment: PROFILE.deFJ.equipment },
  'Airborne / Guards Airborne Division': { strength: 10000, equipment: PROFILE.suAirborne.equipment },
  'Alpine Division "Julia"': { strength: 16000, equipment: PROFILE.itAlpine.equipment },
  'Alpine Division "Tridentina"': { strength: 16000, equipment: PROFILE.itAlpine.equipment },
  'Alpine Division "Cuneense"': { strength: 15000, equipment: PROFILE.itAlpine.equipment },
  '1st SS-Panzer-Division "Leibstandarte"': { strength: 21000, equipment: PROFILE.dePanzer.equipment },
  '2nd SS-Panzer-Division "Das Reich"': { strength: 21000, equipment: PROFILE.dePanzer.equipment },
  '3rd SS-Panzer-Division "Totenkopf"': { strength: 21000, equipment: PROFILE.dePanzer.equipment },
  '5th SS-Panzer-Division "Wiking"': { strength: 19000, equipment: PROFILE.dePanzer.equipment },
  '12th SS-Panzer-Division "Hitlerjugend"': { strength: 20000, equipment: PROFILE.dePanzer.equipment },
  'Fallschirm-Panzer-Division "Hermann Göring"': { strength: 18000, equipment: PROFILE.dePanzer.equipment },
  'Panzergrenadier-Division "Großdeutschland"': { strength: 22000, equipment: PROFILE.dePanzer.equipment },
};
...
const EQUIP_REFS: Record<string, string[]> = {
  ...
  // Minor powers + variants (catalog refs from PROFILE).
  'Romanian Infantry Division': PROFILE.roInf.refs,
  'Romanian Cavalry Division': PROFILE.roCav.refs,
  'Romanian Mountain Division (vânători de munte)': PROFILE.roMtn.refs,
  'Hungarian Infantry Division (honvéd)': PROFILE.huInf.refs,
  'Hungarian Cavalry Division (huszár)': PROFILE.huCav.refs,
  'Hungarian Armoured Division (páncéloshadosztály)': PROFILE.huArm.refs,
  'Hungarian Light Division (könnyű hadosztály)': PROFILE.huLight.refs,
  'Italian Infantry Division (binary)': PROFILE.itInf.refs,
  'Italian Armoured Division': PROFILE.itArm.refs,
  'Italian Motorized Division': PROFILE.itMot.refs,
  'Italian Alpine Division': PROFILE.itAlpine.refs,
  'Alpine Division "Julia"': PROFILE.itAlpine.refs,
  'Alpine Division "Tridentina"': PROFILE.itAlpine.refs,
  'Alpine Division "Cuneense"': PROFILE.itAlpine.refs,
  'Finnish Infantry Division': PROFILE.fiInf.refs,
  'Finnish Cavalry Brigade': PROFILE.fiCav.refs,
  'Bulgarian Infantry Division': PROFILE.bgInf.refs,
  'Royal Yugoslav Infantry Division': PROFILE.yuRoyal.refs,
  'Partisan Division (NOVJ)': PROFILE.yuPartisan.refs,
  'Greek Infantry Division': PROFILE.grInf.refs,
  'British/Commonwealth Infantry Division': PROFILE.gbInf.refs,
  'Gebirgs-Division (mountain)': PROFILE.deGebirgs.refs,
  'Soviet Mountain Rifle Division': PROFILE.suMountain.refs,
  'Guards Rifle Division': PROFILE.suGuards.refs,
  'SS-Panzer-Division': PROFILE.dePanzer.refs,
  'SS-Panzergrenadier-Division': PROFILE.dePzGren.refs,
  'Jäger-Division (light)': PROFILE.deLight.refs,
  'Fallschirmjäger-Division': PROFILE.deFJ.refs,
  'Airborne / Guards Airborne Division': PROFILE.suAirborne.refs,
  '1st SS-Panzer-Division "Leibstandarte"': PROFILE.dePanzer.refs,
  '2nd SS-Panzer-Division "Das Reich"': PROFILE.dePanzer.refs,
  '3rd SS-Panzer-Division "Totenkopf"': PROFILE.dePanzer.refs,
  '5th SS-Panzer-Division "Wiking"': PROFILE.dePanzer.refs,
  '12th SS-Panzer-Division "Hitlerjugend"': PROFILE.dePanzer.refs,
  'Fallschirm-Panzer-Division "Hermann Göring"': PROFILE.dePanzer.refs,
  'Panzergrenadier-Division "Großdeutschland"': PROFILE.dePanzer.refs,
};
